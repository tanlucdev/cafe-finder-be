  ...
  const cafes = [
    {
      ...
      oneLinerEn: 'A striking industrial space for excellent specialty coffee',
    ...
    },
    {
      ...
      oneLinerEn: 'Retro Hanoi style, known for coconut coffee',
    ...
    },
    {
      ...
      oneLinerEn: 'A lush green space filled with natural light',
    ...
    },
    {
      ...
      oneLinerEn: 'Books meet coffee in a haven for readers',
    ...
    },
    {
      ...
      oneLinerEn: 'A polished concept store and cafe in the city center',
    ...
    },
    {
      ...
      oneLinerEn: 'A compact, charming spot with good coffee and music',
    ...
    },
    {
      ...
      oneLinerEn: 'A media brand meets specialty coffee in a sleek modern space',
    ...
    },
    {
      ...
      oneLinerEn: 'A leafy, quiet coffee garden in the heart of Binh Thanh',
    ...
    },
    {
      ...
      oneLinerEn: 'A budget-friendly Vietnamese chain with playful flavors',
    ...
    },
    {
      ...
      district: 'Quận 4',
      districtEn: 'District 4',
      lat: 10.7614,
      lng: 106.7028,
      priceRange: PriceRange.price_50k_100k,
      oneLiner: 'Specialty coffee đỉnh, không gian tối giản đẹp như tranh',
      oneLinerEn: 'Excellent specialty coffee in a beautifully minimal space',
